...
function getStringNodes (g, id, edgeTypes) {
...
exports.vis_handler = (g, handler_id) => {
    const arg = getNameNodes(g, handler_id, ['args', 'next', 'sequence']);
    const std = getStringNodes(g, handler_id, ['state']);
    std.push(
        g.V(handler_id)
        .Tag('subject')
