 ...
 * @param {Function} callback The callback function.
 */
EngineTools.prototype.getInstance = function (app, instanceName, callback) {
    if (typeof instanceName !== "string") {
        return callback(new TypeError("Invalid instance name."));
    }
    if (typeof app !== "string") {
        return callback(new TypeError("Invalid app name."));
    }
    var path = this.getInstancePath(app, instanceName);
    ...
    OneByOne([
      ...
      , function (next, instances) {
            SameTime(instances.map(function (c) {
                return function (cb) {
                    var iName = self.nameFromInstancePath(c);
                    self.getInstance(app, iName, function (err, comp) {
                        if (options.iName) {
                            c = iName;
                        }
                        result[c] = comp;
 ...
 * @param {Object|String} instance The instance object or name.
 * @return {String} The instance path.
 */
EngineTools.prototype.getInstancePath = function (app, instance) {

    if (typeof instance === "string") {
        instance = { name: instance };
    } else if (typeof instance.name !== "string") {
        throw new TypeError("The instance name is required.")
    }

    return Path.join(this.getCompositionDir(app), instance.name + ".json");
};
 ...
 * @param {Function} callback The callback function.
 */
EngineTools.prototype.saveInstance = function (app, instance, callback) {
    if (typeof instance.name !== "string") {
        var err = new TypeError("The instance name is required.");
        if (typeof callback === "function") {
            return callback(err);
        }
        throw err;
    }
    var path = this.getInstancePath(app, instance);
    WriteJson(path, instance, callback);
};
 ...
 * @param {Function} callback The callback function.
 */
EngineTools.prototype.deleteInstance = function (app, instance, callback) {
    ...
    if (typeof instance !== "string") {
        return callback(new TypeError("The instance name is required."));
    }

    var path = this.getInstancePath(app, instance);
    FsPlus.unlink(path, callback);
};
...
EngineTools.prototype.getService = function (app, mod, callback) {
    ...
    ReadJson(self.getServicePath(app, mod), function (err, data) {
        if (!mod) {
            ...
            data = Ul.deepMerge(data, DOT_SERVICE_MOD);
        }
        callback(null, data);
    });
};
 ...
 * @param {Function} callback The callback function.
 */
EngineTools.prototype.setService = function (app, mod, data, callback) {
    var self = this;
    ...
    WriteJson(self.getServicePath(app, mod), data, callback);
};
